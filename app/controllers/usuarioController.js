...
// Controller de Usuários — gerencia fluxo entre Router e Model
...
const usuarioController = {
  ...
  regrasValidacaoProfissional: [
    ...
    body("areaAtuacao")
      .notEmpty()  .withMessage("*Selecione a área de atuação!"),

    body("tempoExperiencia")
      .isInt({ min: 0 }).withMessage("*Informe anos de experiência (0 ou mais)!"),
  ...
  cadastrarCliente: async (req, res) => {
    ...
    if (!errors.isEmpty()) {
      ...
      return res.render("pages/cadastroCliente", {
        valores: req.body, erroValidacao, msgErro, retorno: null,
      });
    }
    ...
    try {
      ...
      // Criar no banco (sem hash por enquanto — adicione bcrypt futuramente)
      ...
      res.render("pages/cadastroCliente", {
        valores: req.body, erroValidacao: {}, msgErro: {},
  ...
  login: async (req, res) => {
    ...
    try {
      ...
      return res.render("pages/login", {
        ...
        valores: { email: login }, erroValidacao: {}, msgErro: {}, sucesso: false,
      });
    } catch (err) {
